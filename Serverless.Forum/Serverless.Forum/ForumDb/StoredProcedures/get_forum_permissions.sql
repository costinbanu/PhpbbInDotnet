	  ...
	  , lateral
		(
			SELECT
			  ...
			  , r1.role_description
			  , CASE
					WHEN r1.role_id = au.auth_role_id
						THEN true
						ELSE false
				END AS has_role
			FROM
	  ...
	  , lateral
		(
			SELECT
			  ...
			  , r1.role_description
			  , CASE
					WHEN r1.role_id = ag.auth_role_id
						THEN true
						ELSE false
				END AS has_role
			FROM
