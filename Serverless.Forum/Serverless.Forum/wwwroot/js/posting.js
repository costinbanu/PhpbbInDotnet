...
var bbtags = new Array('[b]', '[/b]', '[i]', '[/i]', '[u]', '[/u]', '[quote]', '[/quote]', '[code]', '[/code]', '[list]', '[/list]', '[list=]', '[/list]', '[img]', '[/img]', '[url]', '[/url]', '[flash=]', '[/flash]', '[size=]', '[/size]', '[imgur-album]', '[/imgur-album]', '[strike]', '[/strike]', '[youtube]', '[/youtube]');
var imageTag = false;
...
var help_line = {
    ...
    , cb_22: 'Insereaza in mesaj un album gazduit pe www.imgur.com: [imgur-album]COD_ALBUM[/imgur-album]'

    , cb_24: 'text taiat: [strike]text care va fi taiat[/strike]'

    , cb_26: 'Insereaza in mesaj un film gazduit pe www.youtube.com: [youtube]COD_FILM[/youtube]'
