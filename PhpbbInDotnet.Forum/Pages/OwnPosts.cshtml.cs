...
namespace PhpbbInDotnet.Forum.Pages
{
    public class OwnPostsModel : AuthenticatedPageModel
    {
        ...
        public OwnPostsModel(IForumDbContext context, IForumTreeService forumService, IUserService userService, IAppCache cache, ICommonUtils utils, ITranslationProvider translationProvider)
