...
namespace PhpbbInDotnet.Forum.Pages
{
    ...
    public class ViewAttachmentsModel : AuthenticatedPageModel
    {
        ...
        public ViewAttachmentsModel(IForumDbContext context, ForumTreeService forumService, UserService userService, IAppCache cache,  CommonUtils utils, LanguageProvider languageProvider)
