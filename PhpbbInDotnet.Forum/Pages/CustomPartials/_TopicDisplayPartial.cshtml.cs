...
namespace PhpbbInDotnet.Forum.Pages.CustomPartials
{
    public class _TopicDisplayPartialModel : PageModel
    {
        ...
        public _TopicDisplayPartialModel(ForumUserExpanded currentUser, string language, List<TopicDto> topics)
            : this(
                  currentUser, 
                  language, 
                  new List<TopicGroup>
        ...
        public _TopicDisplayPartialModel(ForumUserExpanded currentUser, string language, List<TopicGroup> topicGroups)
        {
