...
namespace PhpbbInDotnet.Forum.Pages
{
    ...
    public partial class PostingModel(IPostService postService, IStorageService storageService, IWritingToolsService writingService, IImageSizeService imageResizeService,
        INumberPlateBlurringService numberPlateBlurringService, IConfiguration config, ILogger logger, IForumTreeService forumService, IUserService userService,
        ISqlExecuter sqlExecuter, ITranslationProvider translationProvider, INotificationService notificationService, ICachedDbInfoService cachedDbInfoService)
