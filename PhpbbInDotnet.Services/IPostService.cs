...
namespace PhpbbInDotnet.Services
{
    public interface IPostService
    {
        ...
        Task<Dictionary<int, List<AttachmentDto>>> CacheAttachmentsAndPrepareForDisplay(IEnumerable<PhpbbAttachmentExpanded> dbAttachments, string language, int postCount, bool isPreview, List<string>? toHighlight = null);
